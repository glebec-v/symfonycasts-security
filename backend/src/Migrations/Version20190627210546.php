 ...
 */
final class Version20190627210546 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ALTER id TYPE INT');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ALTER id TYPE BIGINT');
        $this->addSql('ALTER TABLE article ALTER id DROP DEFAULT');
